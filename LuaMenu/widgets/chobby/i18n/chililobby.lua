return {
	...
	en = {
		...
		plugins_restore_defaults_notification = "Widget folder was backed up and in-game widget settings were reset to defaults.",
		plugins_restore_defaults_failed = "Widget reset could not finish: %{count} backup or config removal operations failed. Check infolog.txt for details.",
