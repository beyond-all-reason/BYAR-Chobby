return {
	...
	en = {
		...
		plugins_restore_defaults_confirm = "This removes every custom widget and resets the in-game widget order, enabled state, and saved widget settings. Continue?",
