return {
	...
	en = {
		...
		delete_account_warning_text = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.\n\nWhat is erased: email, profile and settings, the link between the username and play history; username anonymised in replays, match archives, and leaderboards.\n\nWhat is kept: a non-public anti-abuse record (hashed identifiers, moderation and sanction history, matchmaking rating, linkage honouring other players' ignore/avoid lists), retained for 2 years (5 years or ban duration if the account has moderation actions).",
		delete_account_continue = "Continue",
		delete_account_cancel = "Cancel",
		delete_account_confirm_prompt = "Type your username to confirm:",
		delete_account_confirm_button = "Confirm Deletion",
		delete_account_success = "Account deletion request accepted. Your account will be deactivated and permanently deleted after 30 days. A confirmation email has been sent. Logging in again during this period will cancel the deletion.",
		delete_account_username_error = "Username does not match. Please try again.",
		delete_account_error = "Failed to request deletion. Please contact delete@beyondallreason.info",
