return {
	...
	en = {
		...
		register_extra = 'CAREFUL!\nWe don\'t allow alternate accounts; there are multiple reasons for this:\n \n- Alternate accounts allow people to evade justifiably earned reputations\n- They can disrupt ratings and cause imbalanced games (this applies to both high and low ratings)\n- They enable evading of moderation actions\n \nMany people feel they should be allowed to have an alternate account and are still turned down.\n \n"My new account has lots of games"\nWe don\'t judge alternates based on the number of games they have.\n \n"I prefer this name"\nUse the rename tool, we can scramble the name of the alt account if needed to prevent it being blocked.\n \n"I find the game too hard, I need easier games"\nBy using an alt account you are directly reducing the quality of games; in particular for newer players. Instead we suggest you check out the BAR Academy channel and get tips on how to improve your play. If balanced correctly, every game should be challenging!\n \nHow do I access the website with my old account?\n \nIf you login to the game client and chat `$website` into chat it will send you a one-time link to the website. From there you can view relevant account details. \n \n If after all this you still think you need a new account, head to the Discord at https://discord.gg/beyond-all-reason and #open-ticket to talk to the moderation team. The next screen contains a button to get there.\n \nIF YOU MAKE ALTERNATE ACCOUNTS WITHOUT CONTACTING THE MODERATION TEAM YOU WILL BE PERMANENTLY BANNED.',
