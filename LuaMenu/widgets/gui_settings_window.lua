...
local function GetLobbyTabControls()
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("os_toast_notifications"), "osToastNotifications", true, nil, i18n("os_toast_notifications_tooltip"))
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("os_taskbar_flash"), "osTaskbarFlash", true, nil, i18n("os_taskbar_flash_tooltip"))
