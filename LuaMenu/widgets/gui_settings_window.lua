...
local function GetVoidTabControls()
	...
	children[#children + 1], offset = AddCheckboxSetting(offset, i18n("devModoptions"), "devModoptions", false, WG.ModoptionsPanel.RefreshModoptions, i18n("devModoptionsTooltip"))
