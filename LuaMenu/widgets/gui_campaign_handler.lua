...
local function SelectPlanet(popupOverlay, planetHandler, planetID, planetData, startable)
	...
	local fluffLabels = {
		Label:New{caption = "Primary", objectOverrideFont = WG.Chobby.Configuration:GetFont(3)},
		Label:New{caption = planetData.infoDisplay.primary .. " (" .. planetData.infoDisplay.primaryType .. ") ", objectOverrideFont = WG.Chobby.Configuration:GetFont(3)},
		Label:New{caption = "Type", objectOverrideFont = WG.Chobby.Configuration:GetFont(3)},
		Label:New{caption = planetData.infoDisplay.terrainType or "<UNKNOWN>", objectOverrideFont = WG.Chobby.Configuration:GetFont(3)},
	}
	fluffGrid = Grid:New{
		x = 8,
		y = 60,
	...
	local function SizeUpdate()
		local fluffFont = WG.Chobby.Configuration:GetFont(((planetHandler.height < 720) and 2) or 3)
		local descFont = WG.Chobby.Configuration:GetFont(((planetHandler.height < 720) and 1) or 2)
