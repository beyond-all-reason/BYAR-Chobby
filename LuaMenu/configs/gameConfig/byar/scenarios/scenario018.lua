...
Tips:
 ...
 - Maverick will hill himself quickly after taking damage, and will gain extra HP and a faster reload time with experience gained from damaging enemy units. 
...
The difficulty modifier will change the amount of resources you and the enemy receive from metal and energy production structures:
 ...
 - Brutal: Regular resources for you, +100% for the enemy
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
		...
		featureloadout = {
			{name = 'cormlv_dead', x = 170, y = 75, z = 199, rot = 0 , scale = 1.0, resurrectas = "cormlv"},
		}
    },
