 ...
 - Resources spent to get a confirmed kill on the captured commander.
    ...
    scenariooptions = { -- this will get lua->json->base64 and passed to scenariooptions in game
        ...
        unitloadout = {
			...
			{name = 'cormex', x = 7168, y = 534, z = 7328, rot = 32767 , team = 0},
			{name = 'cormex', x = 7232, y = 534, z = 7776, rot = 32767 , team = 0},
			{name = 'cormex', x = 7424, y = 397, z = 6704, rot = 32767 , team = 0},
			{name = 'cormex', x = 6624, y = 534, z = 7552, rot = 32767 , team = 0},
			{name = 'cornanotc', x = 6888, y = 534, z = 7752, rot = 32767 , team = 0},
			{name = 'cornanotc', x = 6968, y = 534, z = 7752, rot = 32767 , team = 0},
			{name = 'cormex', x = 7648, y = 397, z = 6208, rot = 32767 , team = 0},
			{name = 'cornanotc', x = 7032, y = 534, z = 7752, rot = 32767 , team = 0},
			{name = 'cormex', x = 7936, y = 397, z = 6512, rot = 32767 , team = 0},
			...
			{name = 'armmex', x = 944, y = 534, z = 480, rot = 32767 , team = 1},
			{name = 'armmex', x = 1456, y = 534, z = 688, rot = 32767 , team = 1},
			{name = 'armmex', x = 976, y = 534, z = 976, rot = 32767 , team = 1},
			{name = 'armmex', x = 720, y = 397, z = 1568, rot = 32767 , team = 1},
			{name = 'armmex', x = 208, y = 397, z = 1712, rot = 32767 , team = 1},
			{name = 'armmex', x = 560, y = 397, z = 2080, rot = 32767 , team = 1},
