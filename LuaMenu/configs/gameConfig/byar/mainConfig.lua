...
local externalFuncAndData = {
  ...
  aiTooltip = {
    ...
    ['DAI']= "A medium difficulty non-cheating AI, with great offense (Recommended!)",
    ['STAI']= "A medium difficulty non-cheating AI, excellent all-round performance",
